...
# 当前版本 / Current version: 11
# 说明：当前配置版本为11，如果配置版本不等于11，则需要更新配置文件
# Description: The current configuration version is 11, if the configuration version is not equal to 11, you need to update the configuration file
version: 11
