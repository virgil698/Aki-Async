...
# 当前版本 / Current version: 12
# 说明：当前配置版本为12，如果配置版本不等于12，则需要更新配置文件
# Description: The current configuration version is 12, if the configuration version is not equal to 12, you need to update the configuration file
version: 12
