...
# 当前版本 / Current version: 10
# 说明：当前配置版本为10，如果配置版本不等于10，则需要更新配置文件
# Description: The current configuration version is 10, if the configuration version is not equal to 10, you need to update the configuration file
version: 10
