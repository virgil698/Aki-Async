...
# 当前版本 / Current version: 6
# 说明：当前配置版本为6，如果配置版本不等于6，则需要更新配置文件
# Description: The current configuration version is 6, if the configuration version is not equal to 6, you need to update the configuration file
version: 6
