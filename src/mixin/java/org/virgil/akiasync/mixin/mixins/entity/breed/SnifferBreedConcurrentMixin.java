...
@Mixin(Sniffer.class)
public abstract class SnifferBreedConcurrentMixin extends Animal {

    @Unique
    private final AtomicBoolean aki$breedingFlag = new AtomicBoolean(false);

    protected SnifferBreedConcurrentMixin(EntityType<? extends Animal> entityType, Level world) {
    ...
    private void aki$wrapSpawnChildFromBreeding(ServerLevel world, Animal other, Operation<Void> original) {
        ...
        SnifferBreedConcurrentMixin otherMixin = (SnifferBreedConcurrentMixin) other;
