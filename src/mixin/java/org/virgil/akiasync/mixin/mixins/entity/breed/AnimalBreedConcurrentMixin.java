...
@Mixin(Animal.class)
public abstract class AnimalBreedConcurrentMixin extends Entity {
    ...
    public AnimalBreedConcurrentMixin(EntityType<?> entityType, Level level) {
    ...
    private void aki$wrapSpawnChildFromBreeding(ServerLevel world, Animal other, Operation<Void> original) {
        ...
        AnimalBreedConcurrentMixin otherMixin = (AnimalBreedConcurrentMixin) (Object) other;
