...
/**
 * Fast read-only snapshot for explosion calculation
 * 
 * Captures: BlockState (for resistance) + Entity positions (for hurt/knockback)
...
public class ExplosionSnapshot {
    ...
    /**
     * Entity snapshot (position + AABB + UUID reference)
     */
