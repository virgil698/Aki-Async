...
public class OptimizedStructureLocator {
    ...
    public static synchronized void initialize(org.virgil.akiasync.AkiAsyncPlugin plugin) {
        if (cacheManager == null) {
            cacheManager = StructureCacheManager.getInstance(plugin);
        }
        updateConfiguration(plugin);
    }
    ...
    public static void updateConfiguration(org.virgil.akiasync.AkiAsyncPlugin plugin) {
        if (plugin.getBridge() != null) {
            searchPattern = plugin.getBridge().getStructureSearchPattern();
            biomeAwareSearchEnabled = plugin.getBridge().isBiomeAwareSearchEnabled();
        }
    }
