...
public final class BrainMemorySnapshot {
    ...
    private BrainMemorySnapshot(
            @Nonnull Map<MemoryModuleType<?>, MemoryEntry<?>> memories, 
            long gameTime) {
    ...
    private static final class MemoryEntry<U> {
        ...
        MemoryEntry(@Nonnull U value, long ttl, boolean isExpirable) {
            this.value = value;
            this.ttl = ttl;
    ...
    public <E extends LivingEntity> void applyTo(@Nonnull Brain<E> brain) {
